...
const FeaturesSection = () => {
  return (
    <section id="features" className="py-24 bg-farm-green-light/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-farm-green-light/50 rounded-full w-14 h-14 flex items-center justify-center mb-6">
                {feature.icon}
              </div>
